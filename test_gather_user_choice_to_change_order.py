...
from game import gather_user_choice_to_change_order


class TestGatherUserChoiceToChangeOrder(TestCase):
    ...
    def test_number_of_pokemon_is_two_and_user_choice_is_valid(self, _):
        ...
        expect = 2
        actual = gather_user_choice_to_change_order(character)
